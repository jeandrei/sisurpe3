<?php
    class Fusercomplementacao {
        ...
        public function getUserComplementacoes($_userId){             
            $this->db->query('SELECT fucp.cpId as cpId, fucp.userId as userId, fcp.complementacao as complementacao FROM f_user_complementacao_pedagogica fucp, f_complementacao_pedagogica fcp WHERE fucp.cpId = fcp.cpId AND userId = :userId ORDER BY fcp.complementacao ASC');
            // Bind value
            $this->db->bind(':userId', $_userId);                              
