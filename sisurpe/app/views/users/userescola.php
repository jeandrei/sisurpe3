...
<div class="row">
    <div class="col-12 mt-3 mb-3 text-center">
      <h3><?php echo $data['init']['titulo'] . $data['init']['ano']; ?>.</h3>
    </div>   
</div>

<div class="alert alert-warning" role="alert">
  <h4 class="alert-heading">Escolas em que o servidor leciona!</h4>
  <p>A primeira coisa que devemos fazer na atualização dos seus dados para o ano de <?php echo $data['init']['ano']; ?> é adicionar as escolas em que você trabalha.</p>
  <p>Para isso clique em <b>+ Adicionar</b> para cada escola que você leciona em <?php echo $data['init']['ano']; ?>.</p>
  <hr>
